...
public class Navigation : MonoBehaviour
{
    ...
    void Update()                                  //1프레임마다 실행되는 update메소드
    {
        ...
        //Debug.Log("ARDevice : " + GameObject.Find("ARCore Device").transform.position.y);
        //Debug.Log("ARCamera : " + GameObject.Find("First Person Camera").transform.localPosition.y);
        //Debug.Log("Agent : " + GameObject.Find("SpherePointer").transform.position.y);

        /*if (this.gameObject.transform.position.y > (float)0.09) {
            GameObject.Find("ARCore Device").transform.position = new Vector3(GameObject.Find("ARCore Device").transform.position.x, GameObject.Find(this.gameObject.name).transform.position.y + (float)1.61, GameObject.Find("ARCore Device").transform.position.z);
            GameObject.Find("First Person Camera").transform.localPosition = new Vector3(0, 0, 0);
